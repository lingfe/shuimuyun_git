...
public class R_kuaiketabController {
	...
	public String updataFirst(R_kuaiketab tab, ModelMap model) {
		// 执行修改
		kuaiketabService.updataFirst(tab.getKuaikeName(), tab.getKuaikePhone(), tab.getKuaikeAddressInfo(),
				tab.getKuaikeId());
	...
	public String findBackPassWord(@ModelAttribute("login") R_kuaiketab tab,
			@RequestParam("kuaikePhone") String kuaikePhone, @RequestParam("password") String password) {
		// 对找回的密码进行加密处理
	...
	public String updatePasswordByAppeal(ModelMap model, @RequestParam("newkuaikePhone") String newkuaikePhone,
			@RequestParam("kuaikeName") String kuaikeName, @RequestParam("kuaikePhone") String kuaikePhone) {
		// 手机换绑
	...
	public String updatePasswordByKuaikeNameAndKuaikePhone(ModelMap model, @RequestParam("password") String password,
			@RequestParam("kuaikeName") String kuaikeName, @RequestParam("newkuaikePhone") String newkuaikePhone) {
	...
	// （2）请使用APIID（查看APIID请登录用户中心->验证码、通知短信->帐户及签名设置->APIID）及
	// APIkey来调用接口，APIkey在会员中心可以获取；
	...
	@ResponseBody
	public int getCode(@PathVariable("kuaikePhone") String kuaikePhone,
	...
	public String updatePhoneBykuaikePhoneAndPassword(@ModelAttribute("login") R_kuaiketab ktab, HttpSession session,
			SessionStatus sessionStatus, @RequestParam("regPhone") String regPhone,
			@RequestParam("lastPhone") String lastPhone, @RequestParam("password") String password) {
	...
	public String updatePassWordByOldPassword(HttpSession session, SessionStatus sessionStatus,
			@RequestParam("newPassword") String newPassword, @RequestParam("kuaikeId") String kuaikeId,
