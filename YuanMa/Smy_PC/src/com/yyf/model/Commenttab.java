...
/**
 * 
 * 文件名：Commenttab.java 描述： 下单评论表 修改人： lijie 修改时间：2017年5月23日 下午2:22:58 修改内容：
 */
public class Commenttab {

	private String commentId;// `commentId` VARCHAR(64) NOT NULL COMMENT
								// '评论信息表标识',
	...
	private Date commentDate;// `commentDate` TIMESTAMP NOT NULL DEFAULT
