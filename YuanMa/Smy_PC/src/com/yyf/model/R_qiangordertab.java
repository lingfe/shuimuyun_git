...
public class R_qiangordertab {
	...
	private Integer status;// `status` TINYINT(4) NOT NULL DEFAULT 0 // '状态',状态(0=抢单成功，1=抢单失败，2=等待取货，3=等待配送（点击确认配送），4=已经到达（修改下单状态2，确认到达），5=派单成功)
	 ...
	 * @param qiangId  抢单ID
	 * @param xiaId    下单Id
	 * @param kuaikeId  快客 ID
	 * @param status    状态
	 * @param qiangDate 抢单时间
	 */
