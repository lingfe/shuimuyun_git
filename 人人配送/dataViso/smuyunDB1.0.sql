...
CREATE TABLE `kuaiketab` (
  ...
  `kuaikeShenfenZF` VARCHAR(100)  COMMENT '身份证正反面',
  `kuaikeShouchiSFZ` VARCHAR(100) COMMENT '手持身份证照片',
...
CREATE TABLE `xiaordertab` (
  ...
  `shouhuoAddressInfo` VARCHAR(100)  COMMENT '收货人地址详情',
